...
public class CrainGame {
	public static void main(String[] args) {
	     ...
	     answer = gameStart(board, moves);
	     
	     System.out.println("answer = "+ answer);
	}
	public static int gameStart(int[][]board, int[] moves) {
		...
		for(int move : moves) {
			for(int i=0; i<board.length; i++) {
				if(board[i][move-1]==0) {
					...
					System.out.println(cnt++ +": board["+i+"]["+(move-1)+"] ="+board[i][move-1]);
